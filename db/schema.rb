...
ActiveRecord::Schema[8.1].define(version: 2026_09_21_160000) do
  ...
  create_table "projects", force: :cascade do |t|
    ...
    t.json "packages"
    t.text "readme"
    t.jsonb "release_sync_state", default: {}, null: false
    t.json "repository"
  ...
  create_table "releases", force: :cascade do |t|
    ...
    t.text "download_url"
    t.boolean "draft"
    t.datetime "forge_created_at"
    t.string "html_url"
    t.boolean "immutable"
    t.datetime "last_synced_at"
    t.text "manifests_url"
    t.string "name"
    t.boolean "prerelease"
    t.integer "project_id"
    t.datetime "published_at"
    t.text "purl"
    t.datetime "release_fetched_at"
    t.text "release_url"
    t.datetime "tag_fetched_at"
    t.text "tag_html_url"
    t.string "tag_kind"
    t.string "tag_name"
    t.datetime "tag_published_at"
    t.string "tag_sha"
    t.string "tag_url"
    ...
    t.index ["project_id", "tag_name"], name: "index_releases_on_unique_project_tag", unique: true
